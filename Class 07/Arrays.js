...
let numbers = [45, 21, 2, 2.25]; // correct syntax
console.log(numbers);
let array = [1, 2, 3, "sayyam"]; // Alternative correct syntax
console.log(array);
...
let Array1 = ["Pakistan", "Iran", "China", "India"];
console.log(Array1);
Array1.pop();
console.log(Array1);
...
const Array4 = ["a", "b"];
const Array5 = ["c"];
const concatenatedArray = Array4.concat(Array5);
...
const sum = number.reduce((accumulator, currentNumber) => accumulator + currentNumber, 0);
console.log(sum);
